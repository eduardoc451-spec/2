...
def mostrar_formulario_saude():
 ...
 # =============================================================================
        ...
        # =============================================================================
        # QUESITO 17.7 • PRONTUÁRIO ELETRÔNICO NA URGÊNCIA E EMERGÊNCIA
        # =============================================================================
        with st.container(key=f"container_bloco_pep_urgencia_17_7_{ano_sel}", border=True):
            with st.expander(f"📌 Quesito 17.7 - Prontuário Eletrônico na Urgência/Emergência ({ano_sel})", expanded=True):
                st.subheader(f"17.7 • Prontuário Eletrônico na Urgência e Emergência ({ano_sel})")
                st.write(f"**17.7 O município implantou o Prontuário Eletrônico do Paciente nas Unidades de Urgência e Emergência sob sua gestão?**")
                ...
                opts_17_7 = [
                    "Selecione...",
                    "Sim, para todas as unidades de Urgência e Emergência – 00",
                    "Sim, para a maior parte das unidades de Urgência e Emergência – -01 (perde 01 ponto)",
                    "Sim, para a menor parte das unidades de Urgência e Emergência – -03 (perde 03 pontos)",
                ...
                with c177_1:
                    ...
                    sel_17_7 = st.radio(
                        "Implantação do PEP na Urgência/Emergência:",
                        options=opts_17_7,
                        index=idx_17_7,
                        key=f"rad_pep_urg_17_7_{ano_sel}",
                        label_visibility="collapsed"
                    )

                    map_pts_17_7 = {
                        "Selecione...": 0.0,
                        "Sim, para todas as unidades de Urgência e Emergência – 00": 0.0,
                        "Sim, para a maior parte das unidades de Urgência e Emergência – -01 (perde 01 ponto)": -1.0,
                        "Sim, para a menor parte das unidades de Urgência e Emergência – -03 (perde 03 pontos)": -3.0,
                        "Não – -05 (perde 05 pontos)": -5.0
                    }
                    pts_17_7 = map_pts_17_7.get(sel_17_7, 0.0)
